...
```
THE LESS NX AND NY, THE LESS IS THE NUMBER OF QUANDRANTS INSIDE THE SHAPEFILE
...
CONVERT THE MAP IN THE BRITISH NATIONAL GRID
...
basemap_bng <- OpenStreetMap::openproj(basemap, projection="+init=epsg:27700")
```
